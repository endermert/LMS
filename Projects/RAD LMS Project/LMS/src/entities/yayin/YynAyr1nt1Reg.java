...
@NamedQueries({@NamedQuery(name = "getYynAyr1nt1RegByAyr1d", query = "SELECT y FROM YynAyr1nt1Reg y WHERE y.ayr1d = :ayr1d"),@NamedQuery(name = "getYynAyr1nt1Reg", query = "SELECT y FROM YynAyr1nt1Reg y")})
public class YynAyr1nt1Reg implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof YynAyr1nt1Reg)) {
			return false;
		}
		YynAyr1nt1Reg other = (YynAyr1nt1Reg) obj;
