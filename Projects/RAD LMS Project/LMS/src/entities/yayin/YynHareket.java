...
@NamedQueries({@NamedQuery(name = "getYynHareketByYyn1d", query = "SELECT y FROM YynHareket y WHERE y.yyn1d = :yyn1d"),@NamedQuery(name = "getYynHareketByVerenGrvl11d", query = "SELECT y FROM YynHareket y WHERE y.verenGrvl11d = :verenGrvl11d"),
@NamedQuery(name = "getYynHareketByAlanGrvl11d", query = "SELECT y FROM YynHareket y WHERE y.alanGrvl11d = :alanGrvl11d"),
@NamedQuery(name = "getYynHareketByAktKul1d", query = "SELECT y FROM YynHareket y WHERE y.aktKul1d = :aktKul1d"),
@NamedQuery(name = "getYynHareketByHrk1d", query = "SELECT y FROM YynHareket y WHERE y.hrk1d = :hrk1d"),
@NamedQuery(name = "getYynHareket", query = "SELECT y FROM YynHareket y")})
public class YynHareket implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof YynHareket)) {
			return false;
		}
		YynHareket other = (YynHareket) obj;
